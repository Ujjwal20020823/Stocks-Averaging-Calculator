...
def calculate_opportunity_cost(
    ...
    Args:
        fd_annual_rate: Annual rate in decimal form (e.g. 0.05 for 5%) or as a plain percentage value (e.g. 5.0 for 5%).
    """
    r = fd_annual_rate if fd_annual_rate <= 1.0 else fd_annual_rate / 100.0
